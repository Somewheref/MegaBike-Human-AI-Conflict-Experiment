...
namespace UnityEditor.Rendering.Universal.ShaderGUI
{
    ...
    {
        // customly added
        private const string headerStateKey = "CurvedWorld_LitShader_Header";
        
        private LitGUI.LitProperties litProperties;
        private CurvedWorld_LitDetailGUI.LitProperties litDetailProperties;
        private CurvedWorld_SavedBool m_DetailInputsFoldout;

        public override void OnOpenGUI(Material material, MaterialEditor materialEditor)
        {
            base.OnOpenGUI(material, materialEditor);
            m_DetailInputsFoldout = new CurvedWorld_SavedBool($"{headerStateKey}.DetailInputsFoldout", true);
        }

        public void DrawAdditionalFoldouts(Material material)
        {
            m_DetailInputsFoldout.value = EditorGUILayout.BeginFoldoutHeaderGroup(m_DetailInputsFoldout.value, CurvedWorld_LitDetailGUI.Styles.detailInputs);
            if (m_DetailInputsFoldout.value)
            {
                CurvedWorld_LitDetailGUI.DoDetailArea(litDetailProperties, materialEditor);
