...
namespace KayphoonStudio.Components
    {
    public class KS_SimpleSpawner : MonoBehaviour
    {
        [System.Serializable]
        public class ObjectInfo
        {
            ...
            public KS_Units.DOF_Axis RandomizeSpawnDirection = KS_Units.DOF_Axis.None;
        }
        ...
        public List<GameObject> SpawnObjects()
        {
            ...
            List<GameObject> tempSpawnedObjects = new List<GameObject>();
            ...
            foreach (var obj in Objects)
            {
                for (int i = 0; i < obj.ObjectCount; i++)
                {
                    ...
                    {
                        if (LogInfo)
                            KS_Logger.LogWarning("No spawn position found for " + obj.Prefab.name);
                        continue;
                    }
                    ...
                    tempSpawnedObjects.Add(spawnedObject);
                    spawnedObjectsInfo.Add(spawnedObject, obj);

                }
            }

            return tempSpawnedObjects;
        }
        ...
        public virtual Vector3 GetSpawnPosition(ObjectInfo obj)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                Vector3 upperPosition = KS_Random.Range(b.min, b.max);
